            ...
            <div class="box-body">
                ...
                <table width="100%">
                    <tr class="text-center">
                        ...
                        <td class="network-old" width="15%">24 小时内</td>
                        <td class="network-older" width="20%">&gt; 24 小时</td>
                        <td class="network-never" width="20%">未使用 Pi-hole 的设备</td>
                    </tr>
                </table>
            </div>
            <!-- /.box-body -->
