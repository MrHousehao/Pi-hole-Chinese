        ...
        <div class="box" id="domains-list">
            <div class="box-header with-border">
                ...
                <div class="filter_types">
                    <div class="line">
                        <span><input type="checkbox" name="typ" value="0" id="typ0" checked><label for="typ0">确切白名单</label></span>
                        <span><input type="checkbox" name="typ" value="2" id="typ2" checked><label for="typ2">正侧表达式白名单</label></span>
                    </div>
                    <div class="line">
                        <span><input type="checkbox" name="typ" value="1" id="typ1" checked><label for="typ1">确切黑名单</label></span>
                        <span><input type="checkbox" name="typ" value="3" id="typ3" checked><label for="typ3">正侧表达式黑名单</label></span>
                    </div>
                </div>
            </div>
            <!-- /.box-header -->
