                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-body">
                                <div class="row">
                                    ...
                                    <div class="col-xs-4 text-center">
                                        <a class="btn-link" href="https://pi-hole.net/" rel="noopener" target="_blank">网站</a>
                                    </div>
                                    <div class="col-xs-4 text-center">
                ...
                <div class="pull-left info">
                    <p>状态</p>
                        ...
                        if ($pistatus === "1") {
                            ...
                            echo '<span id="status"><i class="fa fa-circle text-red"></i>DNS 服务器未运行</span>';
                        } else {
                        ...
                        {
                            echo '<span id=\"temperature\"><i class="fa fa-circle text-red"></i>FTL 离线</span>';
                        }
                    ?>
                    <br/>
                    <?php
                  ...
                  <ul class="treeview-menu">
                    <li<?php if($scriptname === "db_queries.php"){ ?> class="active"<?php } ?>>
                        <a href="db_queries.php">
                            <i class="fa fa-fw fa-file-alt"></i>查询请求日志
                        </a>
                    </li>
                ...
                <li class="treeview<?php if (in_array($scriptname, array("messages.php", "gravity.php", "queryads.php", "auditlog.php", "taillog.php", "taillog-FTL.php", "debug.php", "network.php"))){ ?> active<?php } ?>">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li<?php if($scriptname === "queryads.php"){ ?> class="active"<?php } ?>>
                        <a href="queryads.php">
                            <i class="fa fa-fw fa-search"></i>引力场定位
                        </a>
                    </li>
                    <!-- Audit log -->
