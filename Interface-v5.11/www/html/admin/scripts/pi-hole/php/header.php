        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    ...
                    if ($pistatus == 53) {
                        ...
                        echo '<span id="status"><i class="fa fa-w fa-circle text-red"></i>NS 服务器未运行</span>';
                    } elseif ($pistatus == -2) {
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview<?php if($scriptname === "db_queries.php" || $scriptname === "db_lists.php" || $scriptname === "db_graph.php"){ ?> active<?php } ?>">
                  <a href="#">
                    <i class="fa fa-fw menu-icon fa-clock"></i> <span>数据库</span>
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li<?php if($scriptname === "db_graph.php"){ ?> class="active"<?php } ?>>
                        <a href="db_graph.php">
                            <i class="fa fa-fw menu-icon fa-file-alt"></i>图形统计
                        </a>
                    </li>
                    <li<?php if($scriptname === "db_lists.php"){ ?> class="active"<?php } ?>>
                        <a href="db_lists.php">
                            <i class="fa fa-fw menu-icon fa-file-alt"></i>统计表
                        </a>
                    </li>
                  </ul>
                </li>
                  ...
                  <ul class="treeview-menu">
                    <li>
                        <a href="#" id="pihole-disable-indefinitely">
                            <i class="fa fa-fw menu-icon fa-stop"></i>永久
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="#" id="pihole-disable-cst" data-toggle="modal" data-target="#customDisableModal">
                            <i class="fa fa-fw menu-icon fa-clock"></i> <span>自定义时间</span>
                      </a>
                    </li>
                  </ul>
                ...
                <li class="treeview<?php if (in_array($scriptname, array("messages.php", "gravity.php", "queryads.php", "auditlog.php", "taillog.php", "taillog-FTL.php", "debug.php", "network.php"))){ ?> active<?php } ?>">
                  <a href="#">
                    <i class="fa fa-fw menu-icon fa-folder"></i> <span>工具</span>
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                  <ul class="treeview-menu">
                    ...
                    <li<?php if($scriptname === "messages.php"){ ?> class="active"<?php } ?>>
                        <a href="messages.php">
                            <i class="fa fa-fw menu-icon fa-stethoscope"></i>Pi-hole 诊断
                        </a>
                    </li>
                    <!-- Run gravity.sh -->
                    ...
                    <li<?php if($scriptname === "taillog.php"){ ?> class="active"<?php } ?>>
                        <a href="taillog.php">
                            <i class="fa fa-fw menu-icon fa-list-ul"></i>实时显示 pihole.log
                        </a>
                    </li>
                    <!-- Tail pihole-FTL.log -->
                    <li<?php if($scriptname === "taillog-FTL.php"){ ?> class="active"<?php } ?>>
                        <a href="taillog-FTL.php">
                            <i class="fa fa-fw menu-icon fa-list-ul"></i>实时显示 pihole-FTL.log
                        </a>
                    </li>
                    <!-- Generate debug log -->
                ...
                <li<?php if($scriptname === "settings.php"){ ?> class="active"<?php } ?>>
                    <a href="settings.php">
                        <i class="fa fa-fw menu-icon fa-cogs"></i> <span>设置</span>
                    </a>
                </li>
                <!-- Local DNS Records -->
                ...
                <li>
                    <a href="?logout">
                        <i class="fa fa-fw menu-icon fa-user-times"></i> <span>注销</span>
                    </a>
                </li>
                <?php } ?>
                <?php } ?>
                ...
                <li>
                    <a href="https://pi-hole.net/donate/" rel="noopener" target="_blank">
                        <i class="fab fa-fw menu-icon fa-paypal"></i> <span>赞助</span>
                    </a>
                </li>
                 <!-- Docs -->
                 <li>
