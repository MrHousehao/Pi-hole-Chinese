# 汉化Pi-hole的网页界面
基于Pi-hole网页界面v5.21版本进行汉化，轻微调整PHP和JS代码以适应汉化界面。 
对应版本Pi-hole的web-v5.21，搞错版本我不负责！不要完全删除原文件！
[web-v5.21汉化日志](https://github.com/MrHousehao/Pi-hole-Chinese/commit/8292b83b77a222ccaffa170e371bece2b60c162c)
