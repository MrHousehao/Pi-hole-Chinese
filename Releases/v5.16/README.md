# 汉化Pi-hole的网页界面
基于Pi-hole网页界面v5.16版本进行汉化，轻微调整PHP和JS代码以适应汉化界面。 
对应版本Pi-hole的AdminLTE-v5.16，搞错版本我不负责！不要完全删除原文件！
[AdminLTE-v5.16汉化日志](https://github.com/MrHousehao/Pi-hole-Chinese/commit/7e1a803353948250af6f0d3be556450bfe14611d)
