# 汉化Pi-hole的网页界面
基于Pi-hole网页界面v5.19版本进行汉化，轻微调整PHP和JS代码以适应汉化界面。 
对应版本Pi-hole的web-v5.19，搞错版本我不负责！不要完全删除原文件！
[web-v5.19汉化日志](https://github.com/MrHousehao/Pi-hole-Chinese/commit/3e5d6e8f8077f555a19c60ba718d3c0c03df288d)
