# 汉化Pi-hole的网页界面
基于Pi-hole网页界面v5.15.1版本进行汉化，轻微调整PHP和JS代码以适应汉化界面。 
对应版本Pi-hole的AdminLTE-v5.15.1，搞错版本我不负责！不要完全删除原文件！
[AdminLTE-v5.15.1汉化日志](https://github.com/MrHousehao/Pi-hole-Chinese/commit/a8a545cbf5c7cd80ebacea27f87691aae6aaec3e)
