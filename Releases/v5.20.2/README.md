# 汉化Pi-hole的网页界面
基于Pi-hole网页界面v5.20.2版本进行汉化，轻微调整PHP和JS代码以适应汉化界面。 
对应版本Pi-hole的web-v5.20.2，搞错版本我不负责！不要完全删除原文件！
[web-v5.20.2汉化日志](https://github.com/MrHousehao/Pi-hole-Chinese/commit/d6c3e36b0eba4d6494cfdbab0f72ca750218e589)
