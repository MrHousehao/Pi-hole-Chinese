# 汉化Pi-hole的网页界面
基于Pi-hole网页界面v5.18.4版本进行汉化，轻微调整PHP和JS代码以适应汉化界面。 
对应版本Pi-hole的web-v5.18.4，搞错版本我不负责！不要完全删除原文件！
[web-v5.18.4汉化日志](https://github.com/MrHousehao/Pi-hole-Chinese/commit/15c06aad8f641b44d919f1449a35369b4c7e93ae)
