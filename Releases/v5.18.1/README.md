# 汉化Pi-hole的网页界面
基于Pi-hole网页界面v5.18.1版本进行汉化，轻微调整PHP和JS代码以适应汉化界面。 
对应版本Pi-hole的web-v5.18.1，搞错版本我不负责！不要完全删除原文件！
[web-v5.18.1汉化日志](https://github.com/MrHousehao/Pi-hole-Chinese/commit/31e7b371c75fe72d061ff774e82649be271fe2b3)
