# 汉化Pi-hole的网页界面
基于Pi-hole网页界面v5.18.2版本进行汉化，轻微调整PHP和JS代码以适应汉化界面。 
对应版本Pi-hole的web-v5.18.2，搞错版本我不负责！不要完全删除原文件！
[web-v5.18.2汉化日志](https://github.com/MrHousehao/Pi-hole-Chinese/commit/8b580b1e0cb32a1244fb091380b4bdd31bacafe0)
