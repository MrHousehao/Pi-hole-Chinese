# 汉化Pi-hole的网页界面
基于Pi-hole网页界面v5.12版本进行汉化，轻微调整PHP和JS代码以适应汉化界面。 
对应版本Pi-hole的AdminLTE-5.12，搞错版本我不负责！
[AdminLTE-5.12汉化日志](https://github.com/MrHousehao/Pi-hole-Chinese/commit/90ddbb1bdb2097c8077bec0073752e71d23107d9)
