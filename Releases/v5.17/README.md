# 汉化Pi-hole的网页界面
基于Pi-hole网页界面v5.17版本进行汉化，轻微调整PHP和JS代码以适应汉化界面。 
对应版本Pi-hole的AdminLTE-v5.17，搞错版本我不负责！不要完全删除原文件！
[AdminLTE-v5.17汉化日志](https://github.com/MrHousehao/Pi-hole-Chinese/commit/846b2940a90acfd12d068766b65c2455743f1758)
