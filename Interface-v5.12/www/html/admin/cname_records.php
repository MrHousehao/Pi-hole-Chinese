        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input id="domain" type="url" class="form-control" placeholder="添加域名（如 example.com 或 sub.example.com）" autocomplete="off" spellcheck="false" autocapitalize="none" autocorrect="off">
                    </div>
                    <div class="form-group col-md-6">
            ...
            <div class="box-footer clearfix">
              ...
              <p>这是因为Pi-hole在提供<code>CNAME</code> 回应时不会向上游发送额外的查询请求。因此，如果您设置了一个位置的目标，则对客户端的回应可能不完整。Pi-hole只返回查询请求时的已知信息。 这会导致对<code>CNAME</code>目标的某些限制，
                ...
                <p>此外，你无法成功访问<code>CNAME</code> 的外部域名（<code>bing.com</code> 到 <code>google.com</code>），因为当目标服务器不是请求的域名提供内容时，这可能会导致出现无效SSL证书错误。</p>
