...
$(function () {
  tableApi = $("#network-entries").DataTable({
    ...
    columns: [
      ...
      { data: "ip", type: "ip-address", width: "1%", render: $.fn.dataTable.render.text() },
      { data: "hwaddr", width: "12%", render: $.fn.dataTable.render.text() },
      { data: "interface", width: "3%", render: $.fn.dataTable.render.text() },
      { data: "name", width: "6%", render: $.fn.dataTable.render.text() },
      {
        data: "firstSeen",
        width: "9%",
