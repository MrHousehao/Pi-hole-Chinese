            ...
            <div class="box-body">
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input id="domain" type="url" class="form-control" placeholder="添加一个域名（如 microsoft.com 或 mail.microsoft.com）" autocomplete="off" spellcheck="false" autocapitalize="none" autocorrect="off">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="ip">IP地址：</label>
                        <input id="ip" type="text" class="form-control" placeholder="关联IP地址" autocomplete="off" spellcheck="false" autocapitalize="none" autocorrect="off">
                    </div>
                </div>
            </div>
            <div class="box-footer clearfix">
              <strong>备注：</strong>
              <p>本地定义的DNS记录的调阅顺序是：</p>
              <ol>
                  <li>设备的主机名和<code>pi.hole</code></li>
                  <li>在配置文件<code>/etc/dnsmasq.d/</code>中的配置</li>
                  <li>读取来自<code>/etc/hosts</code>中的配置</li>
...
<div id="alWarning" class="alert alert-warning alert-dismissible fade in" role="alert" hidden>
    <button type="button" class="close" data-hide="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    至少有一个域名已经存在，请参见以下输出信息：<br/><br/><pre><span id="warn"></span></pre>
</div>
<div class="row">
    <div class="col-md-12">
