        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation"<?php if ($tab === 'web') { ?> class="active"<?php } ?>>
                    <a href="#web" aria-controls="web" aria-expanded="<?php echo $tab === 'web' ? 'true' : 'false'; ?>" role="tab" data-toggle="tab">Web 界面</a>
                </li>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="danger-area">
                                                        ...
                                                        <p>这些选项在直接连接到互联网（公网）的设备（例如云实例）上使用是危险的，并且只有在您的 Pi-hole 正确设置防火墙时才是安全的。在典型的家庭设置中，您的 Pi-hole 位于本地网络中（并且您的路由器<strong>没有</strong>转发端口53！），这些选项才是安全的。</p>
                                                    </div>
                                                </div>
                ...
                <div id="web" class="tab-pane fade<?php if ($tab === 'web') { ?> in active<?php } ?>">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="box box-warning">
                                <div class="box-header with-border">
                                    <h3 class="box-title">网页界面（自动保存）</h3>
                                </div>
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="icheck-default">
                                                <label for="tempunit-selector"><strong>CPU 温度单位：</strong> </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="icheck-default">
                                                <label for="iCheckStyle"><strong>复选框和单选按钮：</strong> </label>
