  ...
  tableApi = $("#all-queries").DataTable({
    rowCallback: function (row, data) {
      ...
      switch (data[4]) {
        ...
        case 3:
          color = "green";
          fieldtext = "OK <br class='hidden-lg'>（缓存）";
          buttontext =
            '<button type="button" class="btn btn-default btn-sm text-red"><i class="fa fa-ban"></i>添加到黑名单</button>';
          break;
        case 4:
          color = "red";
          fieldtext = "吞噬<br class='hidden-lg'>（正则表达式黑名单）";
          buttontext =
            '<button type="button" class="btn btn-default btn-sm text-green"><i class="fas fa-check"></i>添加到白名单</button>';
          break;
        case 5:
          color = "red";
          fieldtext = "吞噬<br class='hidden-lg'>（确切黑名单）";
          buttontext =
            '<button type="button" class="btn btn-default btn-sm text-green"><i class="fas fa-check"></i>添加到白名单</button>';
          break;
        case 6:
          color = "red";
          fieldtext = "吞噬<br class='hidden-lg'>（外部，IP）";
          break;
        case 7:
          color = "red";
          fieldtext = "吞噬<br class='hidden-lg'>（外部，NULL）";
          break;
        case 8:
          color = "red";
          fieldtext = "吞噬<br class='hidden-lg'>（外部，NXRA）";
          break;
        case 9:
          color = "red";
          fieldtext = "吞噬（引力场，CNAME）";
          buttontext =
            '<button type="button" class="btn btn-default btn-sm text-green"><i class="fas fa-check"></i>添加到白名单</button>';
          break;
        case 10:
          color = "red";
          fieldtext = "吞噬<br class='hidden-lg'>（正则表达式黑名单，CNAME）";
          buttontext =
            '<button type="button" class="btn btn-default btn-sm text-green"><i class="fas fa-check"></i>添加到白名单</button>';
          break;
        case 11:
          color = "red";
          fieldtext = "吞噬<br class='hidden-lg'>（确切黑名单，CNAME）";
          buttontext =
            '<button type="button" class="btn btn-default btn-sm text-green"><i class="fas fa-check"></i>添加到白名单</button>';
          break;
        case 12:
        ...
        case 13:
          color = "green";
          fieldtext = "重试<br class='hidden-lg'>（忽略）";
          buttontext = "";
          break;
        case 14:
          color = "green";
        ...
        case 15:
          color = "text-orange";
          fieldtext = "吞噬<br class='hidden-lg'>（数据库正忙）";
          break;
        default:
          color = "black";
          fieldtext = "未知";
