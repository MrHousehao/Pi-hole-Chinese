    ...
    <footer class="main-footer">
        <div class="row row-centered text-center">
            <div class="col-xs-12 col-sm-6">
                <strong>如果您想支持Pi-hole继续发展，请<a href="https://pi-hole.net/donate/" rel="noopener" target="_blank"><i class="fa fa-heart text-red"></i>赞助</a>Pi-hole。</strong>
            </div>
        </div>
        ...
        <div class="row row-centered text-center version-info">
            <div class="col-xs-12 col-sm-8 col-md-6">
                ...
                <?php if($core_update || $web_update || $FTL_update) { ?>
                    <p>要安装更新，请在终端运行<code><a href="https://docs.pi-hole.net/main/update/">pihole -up</a></code>命令。</p>
                <?php } ?>
                <?php } ?>
            </div>
        </div>
