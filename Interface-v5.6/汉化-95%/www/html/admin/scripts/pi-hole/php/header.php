...
<noscript>
    ...
    <div>
        ...
        <div class="js-warn" id="js-warn-exit"><h1>JavaScript已禁用</h1><p>网站运行需要JavaScript。</p>
            <p>要了解如何启用JavaScript，请点击<a href="https://www.enable-javascript.com/" rel="noopener" target="_blank">启用JavaScript</a></p><label for="js-hide">关闭</label>
        </div>
    </div>
    <!-- /JS Warning -->
</noscript>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview<?php if (in_array($scriptname, array("messages.php", "gravity.php", "queryads.php", "auditlog.php", "taillog.php", "taillog-FTL.php", "debug.php", "network.php"))){ ?> active<?php } ?>">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li<?php if($scriptname === "messages.php"){ ?> class="active"<?php } ?>>
                        <a href="messages.php">
                            <i class="fa fa-fw fa-stethoscope"></i> Pi-hole诊断
                        </a>
                    </li>
                    <!-- Run gravity.sh -->
                ...
                <li class="treeview <?php if(in_array($scriptname, array("dns_records.php", "cname_records.php"))){ ?>active<?php } ?>">
                  <a href="#">
                    <i class="fa fa-fw fa-address-book"></i> <span>本地 DNS</span>                    
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>               
                  </a>
                  <ul class="treeview-menu">
                    <li<?php if($scriptname === "dns_records.php"){ ?> class="active"<?php } ?>>
                        <a href="dns_records.php">
                            <i class="fa fa-fw fa-address-book"></i> <span>DNS 记录</span>
                        </a>
                    </li>
                    <li<?php if($scriptname === "cname_records.php"){ ?> class="active"<?php } ?>>
                        <a href="cname_records.php">
                            <i class="fa fa-fw fa-address-book"></i> <span>CNAME 记录</span>
                        </a>
                    </li>
                  </ul>
                </li>
