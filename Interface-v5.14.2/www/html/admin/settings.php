                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <p id="dhcpnotice" lookatme-text="使用 Pi-hole的DHCP服务器时，请先禁用路由器中的DHCP功能！" <?php if (!$DHCP) { ?>hidden<?php } ?>>使用 Pi-hole的DHCP服务器时，请先禁用路由器中的DHCP功能！</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-12">
...
>&nbsp;<label for="DHCP_rapid_commit"><strong>启用DHCPv4快速提交（快速地址分配）</strong></label></div>
                                                <div><input type="checkbox" name="useIPv6" id="useIPv6" class="DHCPgroup"
<?php
if ($DHCPIPv6) { ?>checked<?php }
if (!$DHCP) { ?> disabled<?php } ?>
>&nbsp;<label for="useIPv6"><strong>启用IPv6支持（SLAAC + RA）</strong></label></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <p>阻止客户端在 <input type="number" name="rate_limit_interval" value="<?=$rate_limit_interval?>" min="0" step="10" style="width: 4em;"> 秒内超过
                                                <input type="number" name="rate_limit_count" value="<?=$rate_limit_count?>" min="0" step="10" style="width: 5em;"> 次的查询请求。</p>
