    ...
    <section style="padding: 15px;">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <div id="cookieInfo" class="panel-title text-center text-red" style="font-size: 150%" hidden>请检查浏览器是否允许使用 Cookie <code><?php echo $_SERVER['HTTP_HOST']; ?></code></div>
...
<div class="login-donate">
    <div class="text-center" style="font-size:125%">
        <strong>如果您觉得 Pi-hole 有用，请<a href="https://pi-hole.net/donate/" rel="noopener" target="_blank"><i class="fa fa-heart text-red"></i> 赞助</a></strong> Pi-hole 。
    </div>
</div>
