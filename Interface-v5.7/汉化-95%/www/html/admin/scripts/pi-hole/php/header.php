...
<noscript>
    ...
    <div>
        ...
        <div class="js-warn" id="js-warn-exit"><h1>JavaScript已禁用</h1><p>网站运行需要JavaScript。</p>
            <p>要了解如何启用JavaScript，请点击<a href="https://www.enable-javascript.com/" rel="noopener" target="_blank">如何启用JavaScript</a></p><label for="js-hide">关闭</label>
        </div>
    </div>
    <!-- /JS Warning -->
</noscript>
...
<div class="wrapper">
    <header class="main-header">
        ...
        <a href="index.php" class="logo">
            ...
            <span class="logo-lg"><strong>Pi-hole</strong></span>
        </a>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <p>状态</p>
                        ...
                        if ($pistatus === "1") {
                            echo '<span id="status"><i class="fa fa-circle text-green-light"></i>激活</span>';
                        } elseif ($pistatus === "0") {
                            echo '<span id="status"><i class="fa fa-circle text-red"></i>离线</span>';
                        } elseif ($pistatus === "-1") {
                            echo '<span id="status"><i class="fa fa-circle text-red"></i>DNS服务器未运行</span>';
                        } else {
                            echo '<span id="status"><i class="fa fa-circle text-orange"></i>未知</span>';
                        }
                        ...
                        if($FTL)
                        {
                            if ($celsius >= -273.15) {
                                ...
                                ?>"></i> 温度：&nbsp;<span id="rawtemp" hidden><?php echo $celsius;?></span><span id="tempdisplay"></span></span><?php
                            }
                        }
                        else
                        {
                            echo '<span id=\"temperature\"><i class="fa fa-circle text-red"></i>FTL离线</span>';
                        }
                    ?>
                    <br/>
                    <?php
                    echo "<span title=\"检测到 $nproc 个核心\"><i class=\"fa fa-circle ";
                        if ($loaddata[0] > $nproc) {
                            echo "text-red";
                        }
                        else
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li<?php if($scriptname === "index.php"){ ?> class="active"<?php } ?>>
                    <a href="index.php">
                        <i class="fa fa-fw fa-home"></i> <span> 运行状态</span>
                    </a>
                </li>
                <?php if($auth){ ?>
                <!-- Query Log -->
                  ...
                  <ul class="treeview-menu">
                    <li<?php if($scriptname === "db_queries.php"){ ?> class="active"<?php } ?>>
                        <a href="db_queries.php">
                            <i class="fa fa-fw fa-file-alt"></i> 全局统计
                        </a>
                    </li>
					<li<?php if($scriptname === "db_graph.php"){ ?> class="active"<?php } ?>>
                        <a href="db_graph.php">
                            <i class="fa fa-fw fa-file-alt"></i> 图形统计
                        </a>
                    </li>
                    <li<?php if($scriptname === "db_lists.php"){ ?> class="active"<?php } ?>>
                        <a href="db_lists.php">
                            <i class="fa fa-fw fa-file-alt"></i> 统计表
                        </a>
                    </li>
                  </ul>
                </li>
                ...
                <li<?php if($scriptname === "whitelist"){ ?> class="active"<?php } ?>>
                    <a href="groups-domains.php?type=white">
                        <i class="fa fa-fw fa-check-circle "></i> <span> 白名单</span>
                    </a>
                </li>
                <!-- Blacklist -->
                <li<?php if($scriptname === "blacklist"){ ?> class="active"<?php } ?>>
                    <a href="groups-domains.php?type=black">
                        <i class="fa fa-fw fa-ban"></i> <span> 黑名单</span>
                    </a>
                </li>
                <!-- Group Management -->
                <li class="treeview<?php if (in_array($scriptname, array("groups.php", "groups-adlists.php", "groups-clients.php", "groups-domains.php"))){ ?> active<?php } ?>">
                  <a href="#">
                    <i class="fa fa-fw fa-users-cog"></i> <span> 群组管理</span>
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                ...
                <li id="pihole-disable" class="treeview"<?php if ($pistatus == "0") { ?> hidden<?php } ?>>
                  <a href="#">
                    ...
                    <i class="fa fa-fw fa-stop"></i> <span>停用&nbsp;&nbsp;&nbsp;<span id="flip-status-disable"></span></span>
                  </a>
                  <ul class="treeview-menu">
                    <li>
                        <a href="#" id="pihole-disable-indefinitely">
                            <i class="fa fa-fw fa-stop"></i> 永久
                        </a>
                    </li>
                    <li>
                        <a href="#" id="pihole-disable-10s">
                            <i class="fa fa-fw fa-clock"></i> 10 秒
                        </a>
                    </li>
                    <li>
                        <a href="#" id="pihole-disable-30s">
                            <i class="fa fa-fw fa-clock"></i> 30 秒
                        </a>
                    </li>
                    <li>
                        <a href="#" id="pihole-disable-5m">
                            <i class="fa fa-fw fas fa-clock"></i> 5 分钟
                        </a>
                    </li>
                    <li>
                      <a href="#" id="pihole-disable-cst" data-toggle="modal" data-target="#customDisableModal">
                            <i class="fa fa-fw fa-clock"></i> <span> 自定义时间</span>
                      </a>
                    </li>
                  </ul>
                ...
                <li class="treeview<?php if (in_array($scriptname, array("messages.php", "gravity.php", "queryads.php", "auditlog.php", "taillog.php", "taillog-FTL.php", "debug.php", "network.php"))){ ?> active<?php } ?>">
                  <a href="#">
                    <i class="fa fa-fw fa-folder"></i> <span>工具</span>
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                  ...
                  <ul class="treeview-menu">
                    <li<?php if($scriptname === "dns_records.php"){ ?> class="active"<?php } ?>>
                        <a href="dns_records.php">
                            <i class="fa fa-fw fa-address-book"></i> <span>DNS 映射</span>
                        </a>
                    </li>
                    <li<?php if($scriptname === "cname_records.php"){ ?> class="active"<?php } ?>>
                        <a href="cname_records.php">
                            <i class="fa fa-fw fa-address-book"></i> <span>CNAME 映射</span>
                        </a>
                    </li>
                  </ul>
                </li>
                ...
                <li>
                    <a href="?logout">
                        <i class="fa fa-fw fa-user-times"></i> <span>注销</span>
                    </a>
                </li>
                <?php } ?>
                <?php } ?>
                ...
                <li<?php if($scriptname === "login"){ ?> class="active"<?php } ?>>
                    <a href="index.php?login">
                        <i class="fa fa-fw fa-user"></i> <span>登录</span>
                    </a>
                </li>
                <?php } ?>
                <!-- Donate -->
                <li>
                    <a href="https://pi-hole.net/donate/" rel="noopener" target="_blank">
                        <i class="fab fa-fw fa-paypal"></i> <span>赞助</span>
                    </a>
                </li>
                 <!-- Docs -->
                 <li>
                    <a href="https://docs.pi-hole.net/" rel="noopener" target="_blank">
                        <i class="fa fa-fw fa-question-circle"></i> <span>资料</span>
                    </a>
                </li>
            </ul>
        </section>
