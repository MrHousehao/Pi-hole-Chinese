...
sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"表中没有可用的数据",sInfo:"显示 _START_ 到 _END_ ，共 _TOTAL_ 个条目",sInfoEmpty:"显示 0 到 0 ，共 0 个条目",sInfoFiltered:"（从总计 _MAX_ 个条目中筛选）",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"显示 _MENU_ 个条目",sLoadingRecords:"载入中...",sProcessing:"处理中...",sSearch:"搜索：",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"没有找到匹配的记录"},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
